...
if (1==1):
	...
	slinexy1, = ax2.plot([],[],lw=5,c='0.7')
	flinexy1, = ax2.plot([],[],lw=5,c='0.7')
	tlinexy1, = ax2.plot([],[],lw=5,c='0.7')
	targetxy1, = ax2.plot([],[],lw=5,c='b')

	slineyz1, = ax3.plot([],[],lw=5,c='0.7')
	flineyz1, = ax3.plot([],[],lw=5,c='0.7')
	tlineyz1, = ax3.plot([],[],lw=5,c='0.7')
	...
	slinexy3, = ax2.plot([],[],lw=5,c='0.7')
	flinexy3, = ax2.plot([],[],lw=5,c='0.7')
	...
	tlinexy2, = ax2.plot([],[],lw=5,c='0.4')
	targetxy2, = ax2.plot([],[],lw=5,c='0.4')
	...
	tlinexy4, = ax2.plot([],[],lw=5,c='0.4')
	targetxy4, = ax2.plot([],[],lw=5,c='0.4')

	slineyz4, = ax3.plot([],[],lw=5,c='0.4')
	flineyz4, = ax3.plot([],[],lw=5,c='0.4')
...
def animate(i):
	...
	angs2[i], angf2[i], angt2[i] = getServoAng(x2[i], y2[i], z2[i], ls, lf, lt)
	angs3[i], angf3[i], angt3[i] = getServoAng(x3[i], y3[i], z3[i], ls, lf, lt)
	angs4[i], angf4[i], angt4[i] = getServoAng(x4[i], y4[i], z4[i], ls, lf, lt)
	...
	xs2 = [0, 0]
	ys2 = [-wspine, -wspine-ls*cos(angs2[i])]
	...
	xtg2 = [x2[i], x2[i]]
	ytg2 = [-wspine+y2[i], -wspine+y2[i]]
	ztg2 = [z2[i], z2[i]]


	xs3 = [-lspine, -lspine]
	ys3 = [0, -ls*cos(angs3[i])]
	...
	xs4 = [-lspine, -lspine]
	ys4 = [-wspine, -wspine-ls*cos(angs4[i])]
